...
$id = $_GET['id'];
echo choos('https://etslive-v3-vidio-com-tokenized.akamaized.net/live/' ,"$id")."\n";
function choos($url, $exxauzt){
    ...
    if (preg_match("/@/", $url)) {
        ...
        $urlreq = "https://etslive-v3-vidio-com-tokenized.akamaized.net/live/$exxauzt/master.m3u8?$token";
    }
    // echo $urlreq;
    $ch = curl_init();
